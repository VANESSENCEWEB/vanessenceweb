...
- Explore AI tools for development productivity
...
- **Contributing to Open Source Projects** - DIO
- **HTML & CSS for Beginners** - Origamid
- **Front-End & UX/UI Design** - Origamid
- **Visual Studio Code Essentials** - LinkedIn Learning
- **Software Architecture Basics** - DIO

### **🗄️ Database**
- **SQLite Database Fundamentals** - Origamid

### **🤖 AI & Emerging Tech**
- **ChatGPT Essentials** - Coursiv
- **Midjourney AI Image Generation** - Coursiv
- **Jasper AI** - Coursiv
- **DALL-E Fundamentals** - Coursiv

### **📈 Digital Marketing**
- **Digital Marketing Strategies** (12h) - Berlim Digital

### **🎯 Soft Skills**
- **LGBTQI+ Workplace Fundamentals** - LinkedIn Learning

> 💡 *All certificates available on [LinkedIn](https://linkedin.com/in/vanessarafaella)*
...
const vanessa = {
    ...
    learning: ["JavaScript", "React", "Node.js", "Git"],
    interests: ["Web Development", "AI Tools", "Open Source"],
    2025Goal: "Land my first dev position",
...
<img src="https://komarev.com/ghpvc/?username=VANESSENCEWEB&color=00F7F7&style=for-the-badge&label=Profile%20Views" alt="Profile Views"/>
